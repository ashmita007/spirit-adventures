...
export const ADVENTURE_SHORTS: AdventureShort[] = [
  {
    ...
    state: "Karnataka",
    region: "South India",
    videoUrl: "/videos/shorts/dandeli_rafting.mp4",
    posterUrl: "/videos/shorts/dandeli_rafting_poster.jpg",
    likes: 3420,
    views: "48K",
  ...
  },
  {
    ...
    state: "Karnataka",
    region: "South India",
    videoUrl: "/videos/shorts/gokarna_beach.mp4",
    posterUrl: "/videos/shorts/gokarna_beach_poster.jpg",
    likes: 4890,
    views: "62K",
  ...
  },
  {
    ...
    state: "Karnataka",
    region: "South India",
    videoUrl: "/videos/shorts/coorg_mist.mp4",
    posterUrl: "/videos/shorts/coorg_mist_poster.jpg",
    likes: 2980,
    views: "39K",
  ...
  },
  {
    ...
    state: "Karnataka",
    region: "South India",
    videoUrl: "/videos/shorts/chikmagalur_peak.mp4",
    posterUrl: "/videos/shorts/chikmagalur_peak_poster.jpg",
    likes: 5120,
    views: "71K",
  ...
  },
  {
    ...
    state: "Kerala",
    region: "South India",
    videoUrl: "/videos/shorts/wayanad_waterfall.mp4",
    posterUrl: "/videos/shorts/wayanad_waterfall_poster.jpg",
    likes: 4180,
    views: "54K",
  ...
  },
  {
    ...
    state: "Tamil Nadu",
    region: "South India",
    videoUrl: "/videos/shorts/ooty_train.mp4",
    posterUrl: "/videos/shorts/ooty_train_poster.jpg",
    likes: 3870,
    views: "44K",
